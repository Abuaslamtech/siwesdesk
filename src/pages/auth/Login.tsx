...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-primary-950 via-primary-800 to-primary-700">
      {/* Decorative blobs */}
      ...
      <div className="relative w-full max-w-md">
        ...
        <p className="text-center text-xs text-primary-300 mt-4">
          © {new Date().getFullYear()} Al-Hikmah University, Ilorin. All rights reserved.
        </p>
      </div>
    </div>
  );
